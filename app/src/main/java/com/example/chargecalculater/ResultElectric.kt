...
class ResultElectric : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val elecforl=intent.getStringExtra("elecforl").toBoolean()
        /*val elecnotl=intent.getBooleanExtra("elecnotl",false)*/
        val elecfamily=intent.getStringExtra("elecfamily")
        val elecwelfare=intent.getStringExtra("elecwelfare")
        ...
        if(eleclowp) //저압용이면
        {
            if(elecforl) //주거용이면
            {
                ...
                else if(elecfamily.equals("5인이상 가구") || elecfamily.equals("3자녀이상 가구") || elecfamily.equals("출산가구"))
                {
                    if(elecsummer)
                    {
                        if(elecuse<=300)
                ...
                else if(elecfamily.equals("생명유지장치") || elecwelfare.equals("사회복지시설"))
                {
                    if(elecsummer)
                    {
                        if(elecuse<=300)
                ...
                else if(elecwelfare.equals("장애인") || elecwelfare.equals("독립유공자") || elecwelfare.equals("국가유공자") || elecwelfare.equals("5.18민주유공자"))
                {
                    if(elecsummer)
                    {
                        if(elecuse<=300)
                ...
                else if(elecwelfare.equals("기초생활수급(생계,의료)"))
                {
                    if(elecsummer)
                    {
                        if(elecuse<=300)
                ...
                else if(elecwelfare.equals("기초생활수급(주거,교육)"))
                {
                    if(elecsummer)
                    {
                        if(elecuse<=300)
                ...
                else if(elecwelfare.equals("차상위계층"))
                {
                    if(elecsummer)
                    {
                        if(elecuse<=300)
